...
def main(**args):
    ...
    for vid_dict in tqdm(cur_split_dicts, total=len(cur_split_dicts), leave=False):
        ...
        joints_blur = torch.zeros([1, 21, 3])
        ...
        if use_cuda and torch.cuda.is_available():
            ...
            joints_blur = joints_blur.to(device=device)
        ...
        for idx, data in enumerate(dataset_obj):
            ...
            joints_blur = joints_blur_re.clone()
            joints_fix = joints_fix_re.clone()
