...
class SMPLifyLoss(nn.Module):
    ...
    def reset_loss_weights(self, loss_weight_dict, opt_idx):
        ...
        print(f"{opt_idx} self.data_weight", self.data_weight)
        print(f"{opt_idx} self.body_pose_weight", self.body_pose_weight)
        print(f"{opt_idx} self.shape_weight", self.shape_weight)
        print(f"{opt_idx} self.bending_prior_weight", self.bending_prior_weight)
        print(f"{opt_idx} self.hand_prior_weight", self.hand_prior_weight)
        print(f"{opt_idx} self.expr_prior_weight", self.expr_prior_weight)
        print(f"{opt_idx} self.jaw_prior_weight", self.jaw_prior_weight)
        print(f"{opt_idx} self.coll_loss_weight", self.coll_loss_weight)
...
class SMPLifyCameraInitLoss(nn.Module):
    ...
    def reset_loss_weights(self, loss_weight_dict, opt_idx):
        ...
        print(f"{opt_idx} self.data_weight {self.data_weight}.")
        print(f"{opt_idx} self.depth_loss_weight {self.depth_loss_weight}.")
        print(f"{opt_idx} self.init_joints_idxs {self.init_joints_idxs}.")
