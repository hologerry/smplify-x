...
from fit_single_frame_raw import fit_single_frame
...
def main(**args):
    ...
    for idx, data in enumerate(dataset_obj):
        ...
        curr_result_fn = osp.join(result_folder, f"{fn}.pkl")
        curr_mesh_fn = osp.join(mesh_folder, f"{fn}.obj")
        ...
        out_img_fn = osp.join(output_folder, f"images", f"{fn}.png")
